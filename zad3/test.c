...
void createStaticTableAndFill()
{
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"create static table and then fill");
}
...
{   
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"find element in static table and delete it");
}
...
void addAndDeleteBlocksStatic()
{
	...
	//displayStaticTableContent(elementsNumber);
	//printf("\n20 elements deleted from table");
	...
	//displayStaticTableContent(elementsNumber);
    //printf("\n20 elements added to table.");

	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"delete and add blocks to static table");
}
...
void addAndDeleteAlternatelyBlocksStatic()
{
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"delete and then add alternetely blocks to static table");
}
...
void createDynamicTableAndFill()
{
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"create dynamic table and then fill");
}
...
{  
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"find element in dynamic table and delete it");
}
...
void addAndDeleteBlocksDynamic()
{
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"delete and add blocks to dynamic table");
}
...
void addAndDeleteAlternatelyBlocksDynamic()
{
	...
	clk = clock() - clk;
    times(&endTime);
	saveResults(stdout,clk,startTime,endTime,"delete and then add alternetely blocks to dynamic table");
}
